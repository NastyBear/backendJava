...
public class Main {
    ...
    private static db.dao.CategoriesMapper getCategoriesMapper(String resource) throws IOException {
        InputStream inputStream = Resources.getResourceAsStream(resource);
    ...
    public static Integer countNumberOfAllCategories() throws IOException {
        db.dao.CategoriesMapper categoriesMapper1 = getCategoriesMapper(resource);
        db.model.CategoriesExample example1 = new db.model.CategoriesExample();
        return Math.toIntExact(categoriesMapper1.countByExample(example1));
    }
